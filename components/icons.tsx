...
export const ArrowLeftOnRectangleIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path fillRule="evenodd" d="M11.828 2.25c-.934 0-1.69.752-1.69 1.682v16.136c0 .93.756 1.682 1.69 1.682h8.422a2.25 2.25 0 002.25-2.25V4.5a2.25 2.25 0 00-2.25-2.25h-8.422zM12 3.932a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.016a.75.75 0 01-.75.75h-.008a.75.75 0 01-.75-.75V3.932z" clipRule="evenodd" />
      <path d="M3.558 2.25a.75.75 0 00-1.06 1.061l2.23 2.23L2.5 7.77a.75.75 0 001.06 1.06l2.25-2.25a.75.75 0 000-1.06l-2.25-2.25z" />
    </svg>
);

export const TrashIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M16.5 4.478v.227a48.816 48.816 0 013.878.512.75.75 0 11-.256 1.478l-.209-.035-1.005 13.006a.75.75 0 01-.749.657H3.125a.75.75 0 01-.75-.657L1.372 6.678l-.209.035a.75.75 0 01-.256-1.478A48.567 48.567 0 017.5 4.705v-.227c0-1.564 1.213-2.9 2.816-2.951a52.662 52.662 0 013.369 0c1.603.051 2.815 1.387 2.815 2.951zm-6.136-1.452a51.196 51.196 0 013.273 0C14.39 3.05 15 3.684 15 4.478v.113a49.488 49.488 0 00-6 0v-.113c0-.794.609-1.428 1.364-1.452z" clipRule="evenodd" />
    </svg>
);
